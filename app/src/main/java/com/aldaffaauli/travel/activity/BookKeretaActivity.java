...
public class BookKeretaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] asal = {"Medan", "Binjai", "Kisaran", "Tj. Balai", "Rantauprapat"};
        final String[] tujuan = {"Medan", "Binjai", "Kisaran", "Tj. Balai", "Rantauprapat"};
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("medan"))
                            || (sAsal.equalsIgnoreCase("binjai") && sTujuan.equalsIgnoreCase("binjai"))
                            || (sAsal.equalsIgnoreCase("kisaran") && sTujuan.equalsIgnoreCase("kisaran"))
                            || (sAsal.equalsIgnoreCase("tj. balai") && sTujuan.equalsIgnoreCase("tj. balai"))
                            || (sAsal.equalsIgnoreCase("rantauprapat") && sTujuan.equalsIgnoreCase("rantauprapat"))) {
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("binjai")) {
            hargaDewasa = 10000;
            hargaAnak = 5000;
        } else if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("kisaran")) {
            hargaDewasa = 30000;
            hargaAnak = 25000;
        } else if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("tj. balai")) {
            hargaDewasa = 35000;
            hargaAnak = 30000;
        } else if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("rantauprapat")) {
            hargaDewasa = 40000;
            hargaAnak = 35000;
        } else if (sAsal.equalsIgnoreCase("binjai") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 10000;
            hargaAnak = 5000;
        } else if (sAsal.equalsIgnoreCase("binjai") && sTujuan.equalsIgnoreCase("kisaran")) {
            hargaDewasa = 35000;
            hargaAnak = 30000;
        } else if (sAsal.equalsIgnoreCase("binjai") && sTujuan.equalsIgnoreCase("tj. balai")) {
            hargaDewasa = 40000;
            hargaAnak = 35000;
        } else if (sAsal.equalsIgnoreCase("binjai") && sTujuan.equalsIgnoreCase("rantauprapat")) {
            hargaDewasa = 45000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("kisaran") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 30000;
            hargaAnak = 25000;
        } else if (sAsal.equalsIgnoreCase("kisaran") && sTujuan.equalsIgnoreCase("binjai")) {
            hargaDewasa = 35000;
            hargaAnak = 30000;
        } else if (sAsal.equalsIgnoreCase("kisaran") && sTujuan.equalsIgnoreCase("tj. balai")) {
            hargaDewasa = 10000;
            hargaAnak = 5000;
        } else if (sAsal.equalsIgnoreCase("kisaran") && sTujuan.equalsIgnoreCase("rantauprapat")) {
            hargaDewasa = 30000;
            hargaAnak = 25000;
        } else if (sAsal.equalsIgnoreCase("tj. balai") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 35000;
            hargaAnak = 30000;
        } else if (sAsal.equalsIgnoreCase("tj. balai") && sTujuan.equalsIgnoreCase("binjai")) {
            hargaDewasa = 40000;
            hargaAnak = 35000;
        } else if (sAsal.equalsIgnoreCase("tj. balai") && sTujuan.equalsIgnoreCase("rantauprapat")) {
            hargaDewasa = 15000;
            hargaAnak = 10000;
        } else if (sAsal.equalsIgnoreCase("tj. balai") && sTujuan.equalsIgnoreCase("kisaran")) {
            hargaDewasa = 10000;
            hargaAnak = 5000;
        } else if (sAsal.equalsIgnoreCase("rantauprapat") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 40000;
            hargaAnak = 35000;
        } else if (sAsal.equalsIgnoreCase("rantauprapat") && sTujuan.equalsIgnoreCase("binjai")) {
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("rantauprapat") && sTujuan.equalsIgnoreCase("tj. balai")) {
            hargaDewasa = 45000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("rantauprapat") && sTujuan.equalsIgnoreCase("kisaran")) {
            hargaDewasa = 30000;
            hargaAnak = 25000;
        }
